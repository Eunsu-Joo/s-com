...
export default function Home() {
  return (
    <main className='flex h-dvh w-dvw flex-row p-0'>
      ...
      <div className='flex flex-1 flex-col justify-center'>
        ...
        <Link href={PATH.SIGNUP} className='c-btn-primary h-[40px] w-[300px]'>
          계정 만들기
        </Link>
        ...
        <Link
          href={PATH.LOGIN_REDIRECT}
          className='c-btn-secondary h-[40px] w-[300px]'
        >
          로그인
        </Link>
      </div>
